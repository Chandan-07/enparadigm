...
private val worqQueue: LinkedBlockingQueue<Runnable> = LinkedBlockingQueue()
    ...
    init {
        ...
        this.threadPoolExecutor= ThreadPoolExecutor(INITIAL_POOL_SIZE, MAX_POOL_SIZE,
            KEEP_ALIVE_TIME.toLong(), KEEP_ALIVE_TIME_UNIT,this.worqQueue,this.threadFactory)
    }

    override fun execute(runnable: Runnable?) {

        if(runnable == null){
          throw IllegalArgumentException("Runnable can not be null")
        }
